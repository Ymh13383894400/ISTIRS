...
public final class ConstSize {
	public static final double Main_Frame_Width=860;
	public static final double Main_Frame_Height=645;
	public static final double Second_Frame_Width=640;
	public static final double Second_Frame_Height=480;
	public static final double Flight_Width=640;
	public static final double Flight_Height=520;
